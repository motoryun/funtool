(() => {
	var i, a, u, f, r, n, o = {
			...
			260: (e, t, r) => {
				...
				var o, i, a, s = r(4019),
					...
					w = w("toStringTag"),
					N = E("TYPED_ARRAY_TAG"),
					O = E("TYPED_ARRAY_CONSTRUCTOR"),
					_ = s && !!x && "Opera" !== d(l.opera),
					s = !1,
					V = {
						Int8Array: 1,
						Uint8Array: 1,
				...
				for (o in V)(a = (i = l[o]) && i.prototype) ? h(a, O, i) : _ = !1;
				for (o in P)(a = (i = l[o]) && i.prototype) && h(a, O, i);
				if ((!_ || !u(T) || T === Function.prototype) && (T = function() {
						throw A("Incorrect invocation")
					}, _))
					for (o in V) l[o] && x(l[o], T);
				if ((!_ || !C || C === k) && (C = T.prototype, _))
					for (o in V) l[o] && x(l[o].prototype, C);
				if (_ && b(r) !== C && x(r, C), c && !p(C, w))
					for (o in s = !0, g(C, w, {
							get: function() {
					...
					exportTypedArrayStaticMethod: function(e, t, r) {
						...
						if (c) {
							if (x) {
								...
								if (T[e] && !r) return;
								try {
									return y(T, e, !r && _ && T[e] || t)
								} catch (e) {}
							}
							for (n in V) !(o = l[n]) || o[e] && !r || y(o, e, t)
						}
					},
					isView: function(e) {
						if (!f(e)) return !1;
						e = d(e);
						return "DataView" === e || p(V, e) || p(P, e)
					},
					isTypedArray: n,
					TypedArray: T,
			...
			3331: (e, t, r) => {
				...
				function l(e, t, r, n) {
					...
					return e = I(r.buffer).bytes, r = o + r.byteOffset, t = O(e, r, r + t), n ? t : W(t)
				}

				function u(e, t, r, n, o, i) {
					if (r = E(r), e = I(e), r + t > e.byteLength) throw Z(M);
				...
				if (v) {
					...
					if (m(function() {
							...
							return new L, new L(1.5), new L(NaN), J && !j
						})) J && j && y(L, "name", B);
					else {
						(F = function(e) {
							return b(this, z), new L(E(e))
						})[D] = z;
						for (var K, H = C(L), Q = 0; H.length > Q;)(K = H[Q++]) in F || y(F, K, L[K]);
						z.constructor = F
					}
					T && S(G) !== V && T(G, V);
					var V = new h(new F(2)),
						X = p(G.setInt8);
					V.setInt8(0, 2147483648), V.setInt8(1, 2147483649), !V.getInt8(0) && V.getInt8(1) || g(G, {
				...
				})[D], d && (k(F, "byteLength"), k(h, "buffer"), k(h, "byteLength"), k(h, "byteOffset")), g(
					G, {
						getInt8: function(e) {
			...
			654: (e, t, r) => {
				...
				e.exports = function(e, t, r, n, o, i, a) {
					...
					var c, l, u, f = t + " Iterator",
						p = !1,
						d = e.prototype,
						v = d[P] || d["@@iterator"] || o && d[o],
						h = !V && v || s(o),
						n = "Array" == t && d.entries || v;
					if (n && (c = E(n.call(new e))) !== Object.prototype && c.next && (b || E(c) === _ || (
							k ? k(c, _) : x(c[P]) || C(c, P, y)), S(c, f, !0, !0), b && (A[f] = y)), N &&
						o == j && v && v.name !== j && (!b && O ? T(d, "name", j) : (p = !0, h =
					function() {
							return m(v, this)
						})), o)
						if (l = {
							...
							for (u in l) !V && !p && u in d || C(d, u, l[u]);
						else g({
							target: t,
							proto: !0,
							forced: V || p
						}, l);
					return b && !a || d[P] === h || C(d, P, h, {
						name: o
					}), A[t] = h, l
				}
			},
			...
			9843: (e, t, r) => {
				...
				function v(e) {
					var t;
					return C(U, e) || "ArrayBuffer" == (t = E(e)) || "SharedArrayBuffer" == t
				}

				function n(e, t) {
					return H(e) && !S(t) && t in e && u(+t) && 0 <= t
				}
				var s = r(2109),
					c = r(7854),
					h = r(6916),
					...
					W = i.TYPED_ARRAY_CONSTRUCTOR,
					q = i.TYPED_ARRAY_TAG,
					$ = i.TypedArray,
					J = i.TypedArrayPrototype,
					K = i.aTypedArrayConstructor,
					H = i.isTypedArray,
					Q = "BYTES_PER_ELEMENT",
					X = "Wrong length",
					I = function(e, t) {
					...
					a = function(e, t) {
						return t = f(t), n(e, t) ? l(2, e[t]) : L(e, t)
					},
					i = function(e, t, r) {
				...
				o ? (Y || (j.f = a, P.f = i, I(J, "buffer"), I(J, "byteOffset"), I(J, "byteLength"), I(J,
					"length")), s({
					target: "Object",
					stat: !0,
					forced: !Y
					...
					Y ? y && (f = t(function(e, t, r, n) {
						return g(e, p), R(k(t) ? v(t) ? void 0 !== n ? new a(t, w(r, u),
							n) : void 0 !== r ? new a(t, w(r, u)) : new a(t) : H(t) ? d(
								f, t) : h(O, f, t) : new a(x(t)), e, f)
					}), A && A(f, $), _(N(a), function(e) {
						e in f || m(f, e, a[e])
						...
						var o, i, a = 0,
							s = 0;
						if (k(t)) {
							if (!v(t)) return H(t) ? d(f, t) : h(O, f, t);
							var c = t,
								s = w(r, u),
								r = t.byteLength;
							if (void 0 === n) {
					...
					}), A && A(f, $), p = f.prototype = T(J)), p.constructor !== f && m(p,
						"constructor", f), m(p, W, f), q && m(p, q, r), e[r] = f, s({
						global: !0,
						forced: f != a,
						sham: !Y
					}, e), Q in f || m(f, Q, u), Q in p || m(p, Q, u), V(r)
				}) : e.exports = function() {}
			},
			3832: (e, t, r) => {
				var n = r(7854),
			...
			8674: (e, t, r) => {
				...
				var n, o, i, a, s = r(2109),
					...
					$ = _.f,
					J = $,
					K = !!(W && W.createEvent && h.dispatchEvent),
					H = b(h.PromiseRejectionEvent),
					...
					j = j(L, function() {
						...
						if (51 <= D && /native code/.test(e)) return !1;
							...
							for (var o, e = p.value, t = p.state == ee, r = 0; v.length > r;) {
								...
								try {
									c ? (t || (p.rejection === ne && function(t) {
										...
										s.promise ? u(Y("Promise-chain cycle")) : (i = ie(n)) ?
										y(i, n, l, u) : l(n)) : u(e)
								} catch (e) {
									f && !a && f.exit(), u(e)
								}
					...
					se = function(e, t, r) {
						var n, o;
						K ? ((n = W.createEvent("Event")).promise = t, n.reason = r, n.initEvent(e, !1, !0), h
							.dispatchEvent(n)) : n = {
							promise: t,
							reason: r
						}, !H && (o = h["on" + e]) ? o(n) : e === Q && O("Unhandled promise rejection", r)
					},
					ce = function(e) {
				...
				if (j && (Z = (U = function(e) {
						...
						return e === U || e === i ? new o : J(e)
					}, !c && b(u) && P !== Object.prototype)) {
					a = P.then, oe || (f(P, "then", function(e, t) {
						var r = this;
	...
	function ie(e) {
		...
		return o[e].call(t.exports, t, t.exports, ie), t.exports
	}
	ie.m = o, ie.n = e => {
		...
		}, a = Object.getPrototypeOf ? e => Object.getPrototypeOf(e) : e => e.__proto__, ie.t = function(t, e) {
			...
			for (var o = 2 & e && t;
				...
				() => t[e]);
			return n.default = () => t, ie.d(r, n), r
		}, ie.d = (e, t) => {
			for (var r in t) ie.o(t, r) && !ie.o(e, r) && Object.defineProperty(e, r, {
				enumerable: !0,
				get: t[r]
			})
		}, ie.f = {}, ie.e = r => Promise.all(Object.keys(ie.f).reduce((e, t) => (ie.f[t](r, e), e), [])), ie.u =
		...
		"." + {
		...
		} [e] + ".js", ie.miniCssF = e => location.href.substring(location.href.indexOf('/'), location.href
			.lastIndexOf('/')) + "/style/" + (3182 === e ? "tinyimg" : e) + "." + {
			3182: "65f8c92f",
			9586: "6b344ab4"
		} [e] + ".css", ie.g = function() {
		...
		}(), ie.o = (e, t) => Object.prototype.hasOwnProperty.call(e, t), u = {}, f = "tools-web:", ie.l = (n, e, t,
			r) => {
			if (u[n]) u[n].push(e);
			else {
				var o, i;
				...
				o || (i = !0, (o = document.createElement("script")).charset = "utf-8", o.timeout = 120, ie.nc && o
					.setAttribute("nonce", ie.nc), o.setAttribute("data-webpack", f + t), o.src = n), u[n] = [e];
				var e = (e, t) => {
			...
			ie.f.j = (r, e) => {
				var t, n, o = ie.o(c, r) ? c[r] : void 0;
				0 !== o && (o ? e.push(o[2]) : (t = new Promise((e, t) => o = c[r] = [e, t]), e.push(o[2] =
					t), t = ie.p + ie.u(r), n = new Error, ie.l(t, e => {
					var t;
					ie.o(c, r) && (0 !== (o = c[r]) && (c[r] = void 0), o && (t = e && (
			...
			var e = (e, t) => {
					var r, n, [o, i, a] = t,
						s = 0;
					if (o.some(e => 0 !== c[e])) {
						for (r in i) ie.o(i, r) && (ie.m[r] = i[r]);
						a && a(ie)
					}
					for (e && e(t); s < o.length; s++) n = o[s], ie.o(c, n) && c[n] && c[n][0](), c[o[s]] = 0
				},
	...
	(() => {
		...
		const f = {
			...
			p = (0, u.createElementVNode)("h1", null, "图片压缩", -1),
			d = {
				class: "row file",
				style: {
			...
			v = (0, u.createElementVNode)("p", {
				...
				.createTextVNode)(" 文件，且不超过"), (0, u.createElementVNode)("span", null, "10MB")], -1),
			h = {
				key: 0,
				class: "row",
				style: {
			...
			E = (0, u.createStaticVNode)(
				'<div class="row table_th"><div class="table_td" style="flex-grow:1;">文件名</div><div class="table_td size">压缩前</div><div class="table_td size">压缩后</div><div class="table_td size">压缩率</div><div class="table_td" style="width:200px;">状态</div><div class="table_td" style="width:150px;flex-shrink:0;">操作</div></div>',
				1),
			k = {
				class: "table_td",
				style: {
			...
			N = (0, u.createTextVNode)(" 删除 "),
			O = (0, u.createTextVNode)(" 下载 "),
			_ = (0, u.createTextVNode)(" 重试 "),
			V = {
				key: 2,
				class: "row files placeholder"
			},
			P = (0, u.createStaticVNode)(
				'<div class="statement"><h2 class="lsb">常见图片格式介绍</h2><h4 class="lsb">JPEG</h4><p>JPEG格式，也叫做JPG或JPE格式，是最常用的一种文件格式，Photoshop“存储为”命令中默认的图片格式就是JPEG，大部分手机相机拍照的照片也是JPE格式。</p><p>JPEG格式的压缩技术十分先进，能够将图像压缩在很小的储存空间，不过这种压缩是有损耗的，过度压缩会降低图片的质量。JPEG格式压缩的主要是高频信息，对色彩的信息保留较好，因此特别适合应用于互联网，可减少图像的传输和加载时间。</p><h4 class="lsb">PNG</h4><p>PNG也是常见的一种图片格式，它最重要的特点是支持 alpha 通道透明度，也就是说，PNG图片支持透明背景。比如在使用Photoshop制作透明背景的圆形logo时，如果使用JPG格式，则图片背景会默认地存为白色，使用PNG格式则可以存为透明背景图片。</p><p>PNG格式图片也支持有损耗压缩，虽然PNG 提供的压缩量比JPG少，但PNG图片却比JPEG图片有更小的文档尺寸，因此现在越来越多的网络图像开始采用PNG格式。</p><h4 class="lsb">GIF</h4><p>GIF也是一种压缩的图片格式，分为动态GIF和静态GIF两种。</p><p>GIF格式的最大特点是支持动态图片，并且支持透明背景。网络上绝大部分动图、表情包都是GIF格式的，相比与动画，GIF动态图片占用的存储空间小，加载速度快，因此非常流行。</p></div><div class="related-links"><h4 class="title">相关链接:</h4><a class="link" href="./img2webp.html">图片转webp</a><a class="link" href="./code2img.html">代码生成图片</a><a class="link" href="./image-generator.html">占位图</a><a class="link" href="./favicon.html">Favicon 生成</a></div>',
				2);
		ie(8674), ie(3948), ie(5827), ie(9575), ie(2472), ie(3824), ie(4916);
		var e = ie(6125);
		const s = {
				key: 0,
			...
			n = (0, r.Z)(t, [
				["render", function(e, t, r, n, o, i) {
					...
					return (0, u.openBlock)(), (0, u.createElementBlock)("div", {
						...
						(0, u.openBlock)(), (0, u.createElementBlock)("div", I)) : (0, u
		...
		t = {
			...
			["render", function(e, t, r, n, o, i) {
				...
				return (0, u.openBlock)(), (0, u.createElementBlock)("div", D, [M, (0, u.createVNode)(a, {
		...
		const {
			ref: Y,
			computed: W,
			defineAsyncComponent: q
		} = Vue, $ = 52428800, J = Y([]), K = W(() => {
			let t = 0;
		...
		let Q = !1;
		const X = e => ["error", "timeout"].includes(e),
			ee = e => {
				if (e) {
					var t = 50 - J.value.length;
					if (e.length > t) Q || (Q = !0, B.warning("最大数量为50，请先清除部分文件再重试"), setTimeout(() => {
						Q = !1
					}, 5e3));
					else {
						[...e].forEach(e => {
						...
						const r = [];
						J.value.forEach(e => {
							"waiting" === e.value.state && r.push(te(e))
						}), r.reduce((e, t) => e.then(t), Promise.resolve())
					}
				}
			},
			te = o => e => new Promise(t => {
				try {
					const r = o.value["origin"],
						n = r["size"];
					U(r, 0, 8).then(e => {
						if (Z(new Uint8Array(e)).state)
							if (n > $) o.value.state = "error", o.value.stateDesc = "文件过大", B
								.warning("文件不得超过50 MB"), t();
							else {
								let e = new FormData;
								e.append("file", r), axios.post("/api/v1/tools/img-compress", e, {
									onUploadProgress: e => {
										e = e.loaded / e.total;
										1 <= (o.value.progress = e) && setTimeout(
									() => {
											"waiting" === o.value.state && (o
													.value.state = "timeout"),
												t()
										}, 15e3)
									},
									...
									e.data.code < 0 ? (o.value.state = "error", o.value
										.stateDesc = e.data.msg) : (e = e.data["file"],
										e && (o.value = {
											...o.value,
											file: e,
											state: "finished"
									...
									/^Error: timeout of/.test(e) ? (o.value.state =
										"timeout", o.value.stateDesc = "网络超时") : (o
										.value.state = "error", o.value.stateDesc =
										"网络错误"), t()
								})
							}
						else B.warning("文件错误，仅支持jpg/png/jpeg/gif图片"), o.value.state = "error", o
							.value.stateDesc = "文件类型错误", t()
					})
				} catch (e) {
					console.log(e), t()
				}
			...
			re = e => {
				e.value.state = "waiting";
				const t = te(e);
				t()
			};
		t = {
			components: {
				"main-header": q(() => Promise.all([ie.e(8914), ie.e(9586)]).then(ie.bind(ie, 8914))),
				[e.Z.name]: e.Z,
				[n.name]: n,
				Footer: t
			},
			setup() {
				return {
					...
					uploadStateDesc: e => X(e.state) ? e.stateDesc || "网络异常" : e.progress ? e.progress < 1 ?
						"上传中..." : "waiting" === e.state ? "处理中..." : "finished" === e.state ? "完成" :
						"网络异常" : "等待中...",
					uploadStateColor: e => X(e.state) ? "#f56c6c" : e.progress < 1 ? "#409eff" :
						"waiting" === e.state ? "#e6a23c" : "finished" === e.state ? "#67c23a" : "#f56c6c",
					download: e => {
						var t = e["file"];
						t && (e = G("sessionId"), console.log("start download", e), e ? (e = "".concat(
								e, "/output/").concat(t.name), e = "/files/upload/".concat(e),
							console.log("url", e), z(e, t.name)) : B.danger("没有文件可以下载"))
					},
					downloadAll: () => {
						const t = new FormData;
						J.value.forEach(e => {
							t.append("filenames", e.value.file.name)
						}), axios.post("/api/v1/tools/files/download-all", t).then(e => {
							var e = e.data["zip"];
							z("/files/upload/".concat(e), e)
						})
					},
					busy: W(() => {
						let t = !1;
					...
					sizeFormatter: e => {
						let t = " KB";
						return 1024 <= (e /= 1024) && (t = " MB", e /= 1024), e.toFixed(2) + t
					},
					compressPercent: e => {
						var {
							origin: t,
						...
						if (e) {
							t = t.size, e = e.size;
							return (Math.abs(t - e) / t * 100).toFixed(2) + "%"
						}
						return ""
					},
					isIncrease: e => {
						...
						return e ? t.size < e.size : null
					},
					clear: () => {
						J.value.length <= 0 || axios.post("/api/v1/tools/files/clear").then(e => {
							var {
								code: t,
								msg: e
							} = e.data;
							0 !== t ? B.danger(e) : (J.value = [], B.success("删除成功"))
						})
					},
					remove: (e, t) => {
						if (X(e.state)) J.value.splice(t, 1), B.success("记录移除成功");
						else {
							var e = e["file"];
							const r = new FormData;
							r.append("file", e.name), axios.post("/api/v1/tools/files/remove", r).then(
								e => {
									0 === e.data.code ? (J.value.splice(t, 1), B.success(
										"记录移除成功")) : B.danger(e.data.msg)
								})
						}
					},
					retry: re
		...
		const ne = (0, r.Z)(t, [
				["render", function(n, e, t, o, r, i) {
					...
					return (0, u.openBlock)(), (0, u.createElementBlock)(u.Fragment, null, [(0, u
						...
						type: "drag",
						width: "100%",
						onChange: o.handleFileChange,
						multiple: ""
					}, null, 8, ["onChange"]), v]), 0 < o.files.length ? ((0, u
						.openBlock)(), (0, u.createElementBlock)("div", h, [(0,
						u.createElementVNode)("p", y, [(0, u
						.createTextVNode)(" 进度：" + (0, u
							.toDisplayString)(o.totalCount) +
						" / " + (0, u.toDisplayString)(o.files
							.length), 1), o.failCount ? ((0, u
						.openBlock)(), (0, u
						.createElementBlock)("span", g,
						"，失败 " + (0, u.toDisplayString)(o
							.failCount) + " 个", 1)) : (0, u
						...
						null, (0, u.renderList)(o.files, (t,
							...
							])]))), 128))])])) : ((0, u.openBlock)(), (0, u
						.createElementBlock)("div", V)), P]), (0, u.createVNode)(l)], 64)
				}]
			]),
			oe = Vue.createApp({
				render() {
