(() => {
	var u, p, r, n, o = {
			...
			654: (e, t, r) => {
				...
				e.exports = function(e, t, r, n, o, i, a) {
					...
					if (n && (c = E(n.call(new e))) !== Object.prototype && c.next && (b || E(c) === j || (
							S ? S(c, j) : x(c[P]) || C(c, P, m)), k(c, p, !0, !0), b && (O[p] = m)), _ &&
						o == B && v && v.name !== B && (!b && N ? V(f, "name", B) : (d = !0, h =
					function() {
							return g(v, this)
						})), o)
						if (l = {
			...
			408: (e, t, r) => {
				...
				e.exports = function(e, t, r) {
					...
					if (f) i = e;
						...
						if (!(f = V(e))) throw O(x(e) + " is not iterable");
						if (w(f)) {
							for (a = 0, s = E(e); a < s; a++)
			...
			261: (e, t, r) => {
				...
				m && y || (m = function(e) {
					...
					.protocol && !u(r) ? (o = r, i.addEventListener("message", O, !1)) : o = V in f(
						"script") ? function(e) {
			...
			8674: (e, t, r) => {
				...
				var n, o, i, a, s = r(2109),
					...
					W = j.f,
					Y = W,
					H = !!(U && U.createEvent && h.dispatchEvent),
					...
					se = function(e, t, r) {
						var n, o;
						H ? ((n = U.createEvent("Event")).promise = t, n.reason = r, n.initEvent(e, !1, !0), h
							.dispatchEvent(n)) : n = {
							promise: t,
							reason: r
	...
	x.m = o, x.n = e => {
		...
		} [e] + ".js", x.miniCssF = e => location.href.substring(location.href.indexOf('/'), location.href
			.lastIndexOf('/')) + "/style/" + (9563 === e ? "des" : e) + "." + {
			1094: "2bd94023",
			4195: "a58731e0",
			9563: "34690da9"
		} [e] + ".css", x.g = function() {
	...
	(() => {
		...
		const u = {
			...
			d = (0, l.createElementVNode)("h1", null, "DES 加密、解密", -1),
			f = (0, l.createElementVNode)("div", {
				class: "statement"
			}, [(0, l.createElementVNode)("h2", {
				class: "lsb"
			}, "DES 介绍"), (0, l.createElementVNode)("p", null,
				" DES全称为Data Encryption Standard，即数据加密标准，是一种使用密钥加密的块算法。"), (0, l.createElementVNode)(
				"p", null, "1977年被美国联邦政府的国家标准局确定为联邦资料处理标准（FIPS），并授权在非密级政府通信中使用，随后该算法在国际上广泛流传开来。"), (0, l
				.createElementVNode)("p", null,
				"需要注意的是，在某些文献中，作为算法的DES称为数据加密算法（Data Encryption Algorithm,DEA），已与作为标准的DES区分开来。"), (0, l
				.createElementVNode)("p", null, "DES算法的入口参数有三个：Key、Data、Mode。"), (0, l
				.createElementVNode)("p", null,
				...
				), (0, l.createElementVNode)("p", null,
				"DES设计中使用了分组密码设计的两个原则：混淆（confusion）和扩散(diffusion)，其目的是抗击敌手对密码系统的统计分析。"), (0, l
				.createElementVNode)("p", null,
				"混淆，是使密文的统计特性与密钥的取值之间的关系尽可能复杂化，以使密钥和明文以及密文之间的依赖性对密码分析者来说是无法利用的。"), (0, l
				.createElementVNode)("p", null,
		...
		var e = {
			...
			n = {
				components: {
					"main-header": Vue.defineAsyncComponent(() => Promise.all([x.e(8914), x.e(1094)]).then(x
						.bind(x, 8914))),
					"crypto-encrypt": Vue.defineAsyncComponent(() => Promise.all([x.e(1354), x.e(4195)]).then(x
						.bind(x, 8190))),
					Footer: r
				}
			};
