(() => {
	var u, p, r, n, o = {
			...
			654: (e, t, r) => {
				...
				e.exports = function(e, t, r, n, o, i, a) {
					...
					var c, l, u, p = t + " Iterator",
						d = !1,
						f = e.prototype,
						v = f[L] || f["@@iterator"] || o && f[o],
						m = !T && v || s(o),
						n = "Array" == t && f.entries || v;
					if (n && (c = E(n.call(new e))) !== Object.prototype && c.next && (b || E(c) === j || (
							S ? S(c, j) : x(c[L]) || V(c, L, h)), k(c, p, !0, !0), b && (N[p] = h)), O &&
						o == B && v && v.name !== B && (!b && _ ? C(f, "name", B) : (d = !0, m =
					function() {
							return g(v, this)
						})), o)
						if (l = {
			...
			408: (e, t, r) => {
				...
				e.exports = function(e, t, r) {
					...
					if (f) i = e;
						...
						if (!(f = C(e))) throw N(x(e) + " is not iterable");
						if (w(f)) {
							for (a = 0, s = E(e); a < s; a++)
			...
			261: (e, t, r) => {
				...
				h && y || (h = function(e) {
					...
					.protocol && !u(r) ? (o = r, i.addEventListener("message", N, !1)) : o = C in f(
						"script") ? function(e) {
			...
			8674: (e, t, r) => {
				...
				var n, o, i, a, s = r(2109),
					...
					H = j.f,
					K = H,
					Y = !!(q && q.createEvent && m.dispatchEvent),
							...
							d.reactions = [], d.notified = !1, f && !d.rejection && (o = d, h(V, m,
								function() {
									var e, t = o.facade,
										...
										n = ce(o);
									if (n && (e = T(function() {
											M ? W.emit("unhandledRejection", r, t) :
												se(X, t, r)
					...
					se = function(e, t, r) {
						var n, o;
						Y ? ((n = q.createEvent("Event")).promise = t, n.reason = r, n.initEvent(e, !1, !0), m
							.dispatchEvent(n)) : n = {
							promise: t,
							reason: r
				...
				if (B && (U = ($ = function(e) {
						...
						then: function(e, t) {
							var r = F(this),
								n = r.reactions,
								o = H(C(this, $));
							return o.ok = !b(e) || e, o.fail = b(t) && t, o.domain = M ? W.domain :
						...
						return e === $ || e === i ? new o : K(e)
					}, !c && b(u) && L !== Object.prototype)) {
	...
	function V(e) {
		...
		return o[e](t, t.exports, V), t.exports
	}
	V.m = o, V.n = e => {
		...
		location.href.substring(location.href.indexOf('/'),location.href.lastIndexOf('/')) + "/lib/" + e + "." + {
		...
		} [e] + ".js", V.miniCssF = e => location.href.substring(location.href.indexOf('/'),location.href.lastIndexOf('/')) + "/style/" + (3661 === e ? "url" : e) + "." + {
			1094: "2bd94023",
			3661: "c99542ac"
		} [e] + ".css", V.g = function() {
		...
		}(), V.o = (e, t) => Object.prototype.hasOwnProperty.call(e, t), u = {}, p = "tools-web:", V.l = (n, e, t,
			r) => {
			if (u[n]) u[n].push(e);
			else {
				var o, i;
				...
				o || (i = !0, (o = document.createElement("script")).charset = "utf-8", o.timeout = 120, V.nc && o
					.setAttribute("nonce", V.nc), o.setAttribute("data-webpack", p + t), o.src = n), u[n] = [e];
				var e = (e, t) => {
			...
			V.f.j = (r, e) => {
				var t, n, o = V.o(c, r) ? c[r] : void 0;
				0 !== o && (o ? e.push(o[2]) : (t = new Promise((e, t) => o = c[r] = [e, t]), e.push(o[2] =
					t), t = V.p + V.u(r), n = new Error, V.l(t, e => {
					var t;
					V.o(c, r) && (0 !== (o = c[r]) && (c[r] = void 0), o && (t = e && (
			...
			var e = (e, t) => {
					...
					for (e && e(t); s < o.length; s++) n = o[s], V.o(c, n) && c[n] && c[n][0](), c[o[s]] = 0
				},
	...
	(() => {
		...
		const d = {
			...
			v = (0, p.createElementVNode)("h1", null, "Url 编码、解码", -1),
			m = {
				class: "row"
			},
			h = (0, p.createElementVNode)("div", null, "忽略保留字符 ; , / ? : @ & = + $ #", -1),
			y = {
				class: "vblock-m"
			},
			g = {
			...
			E = (0, p.createElementVNode)("div", {
				...
				style: {
					...
					class: "lsb"
				}, "为什么要URLEncode"), (0, p.createElementVNode)("p", null,
					" URL在定义时，定义为只支持ASCII字符，所以URL的发送方与接收方都只能处理ASCII字符。所以当你的URL中有非ASCII字符时就需要编码转换。 "), (0, p
					.createElementVNode)("p", null,
					"在Web程序中进行URL请求时，常会遇到URL中含有特殊字符的问题，常见的特殊字符有 ?$&*@等字符，或者是中文。"), (0, p.createElementVNode)
				("p", null, "遇到这种情况时，就要对URL进行编码，用一种规则替换掉这些特殊字符，这就是URLEncode"), (0, p.createElementVNode)(
					"h2", {
						class: "lsb"
					}, "URLEncode 规则"), (0, p.createElementVNode)("p", null, "1.将空格转换为加号（+） "), (0, p
					.createElementVNode)("p", null, "2.对0-9、a-z、A-Z之间的字符保持不变 "), (0, p.createElementVNode)(
					"p", null,
					...
					), (0, p.createElementVNode)("p", null, "4.空格也可以直接用其十六进制编码方式，即用%20表示，而不是将它转换为加号（+）。")
			], -1);
		V(8674), V(3948);
		const a = {
				key: 0,
				...
				["render", function(e, t, r, n, o, i) {
					return (0, p.openBlock)(), (0, p.createElementBlock)("div", {
						...
						onClick: t[0] || (t[0] = (0, p.withModifiers)(function() {
							return i.handleChange && i.handleChange(...arguments)
						}, ["stop"]))
					}, [(0, p.createElementVNode)("div", {
						class: (0, p.normalizeClass)(["yt-switch__inner", {
							"is-active": r.modelValue === r.trueLabel
						}])
					}, [r.inactiveText ? ((0, p.openBlock)(), (0, p.createElementBlock)(
							"span", a, (0, p.toDisplayString)(r.inactiveText), 1)) : (0,
							p.createCommentVNode)("v-if", !0), (0, p.createElementVNode)
						("div", {
							class: "yt-switch__core",
							style: (0, p.normalizeStyle)(i.theme)
						}, s, 4), r.activeText ? ((0, p.openBlock)(), (0, p
							.createElementBlock)("span", c, (0, p.toDisplayString)(r
							.activeText), 1)) : (0, p.createCommentVNode)("v-if", !0)
					], 2)])
				}]
			]),
			n = V(2511),
		...
		e = {
			...
			["render", function(e, t, r, n, o, i) {
				...
				return (0, p.openBlock)(), (0, p.createElementBlock)("div", l, [u, (0, p
					.createElementVNode)("div", S, [k, (0, p.createElementVNode)(
				"span", {
					style: {
						cursor: "pointer",
						"font-size": "12px"
			...
			methods: {
				handleEncode() {
					this.ignore ? this.result = encodeURI(this.input) : this.result = encodeURIComponent(
						this.input)
				},
				handleDecode() {
		...
		const i = (0, t.Z)(e, [
				["render", function(e, t, r, n, o, i) {
					var a = (0, p.resolveComponent)("main-header"),
						s = (0, p.resolveComponent)("yt-switch"),
						c = (0, p.resolveComponent)("yt-input"),
						l = (0, p.resolveComponent)("yt-button"),
						u = (0, p.resolveComponent)("Footer");
					return (0, p.openBlock)(), (0, p.createElementBlock)("div", d, [(0, p.createVNode)(
						a), (0, p.createElementVNode)("div", f, [v, (0, p
						.createElementVNode)("div", m, [(0, p.createVNode)(s, {
						modelValue: o.ignore,
						"onUpdate:modelValue": t[0] || (t[0] = e => o
							.ignore = e),
						onChange: i.handleEncode,
						width: "40"
					}, null, 8, ["modelValue", "onChange"]), h]), (0, p
						.createElementVNode)("div", y, [(0, p.createVNode)(c, {
						type: "textarea",
						size: "small",
						rows: 8,
						modelValue: o.input,
						"onUpdate:modelValue": t[1] || (t[1] = e => o
							.input = e),
						onInput: i.handleEncode,
						resizable: "",
						placeholder: "填写内容"
					}, null, 8, ["modelValue", "onInput"])]), (0, p
						.createElementVNode)("div", g, [(0, p.createVNode)(l, {
						type: "primary",
						size: "small",
						plain: "",
						icon: "el-icon-bottom",
						onClick: i.handleEncode
					}, {
						default: (0, p.withCtx)(() => [b]),
						_: 1
					}, 8, ["onClick"]), (0, p.createVNode)(l, {
						type: "primary",
						size: "small",
						plain: "",
						icon: "el-icon-bottom",
						onClick: i.handleDecode
					}, {
						default: (0, p.withCtx)(() => [x]),
						_: 1
					}, 8, ["onClick"])]), (0, p.createElementVNode)("div", w, [(0, p
						.createVNode)(c, {
						type: "textarea",
						size: "small",
						rows: 8,
						modelValue: o.result,
						"onUpdate:modelValue": t[2] || (t[2] = e => o
							.result = e),
						readonly: "",
						resizable: "",
						placeholder: "结果显示"
					}, null, 8, ["modelValue"])]), E]), (0, p.createVNode)(u)])
				}]
			]),
			C = Vue.createApp({
				render() {
